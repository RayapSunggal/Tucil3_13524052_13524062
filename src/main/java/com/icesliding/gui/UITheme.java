...
final class UITheme {
    ...
    static final Color ACTOR=new Color(0x1E5BFF);
    static final Color ACTOR_SOFT=new Color(0x6E94FF);
    static final Color ACTOR_INK=new Color(0xFFFFFF);
    static final Color GOAL=new Color(0xB019C7);
    static final Color GOAL_SOFT=new Color(0xE9A7F2);
    static final Color GOAL_INK=new Color(0x4A0656);
    ...
    static final Color LAVA=new Color(0xFF1F1F);
    static final Color LAVA_SOFT=new Color(0xFF6A4A);
    static final Color LAVA_INK=new Color(0xFFFFFF);
