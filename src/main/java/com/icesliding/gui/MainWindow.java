...
public class MainWindow extends JFrame {
    ...
    private JPanel buildHeader() {
        ...
        JLabel subtitle=new JLabel("A* Pathfinding Solver");
    ...
    private JPanel buildSidebar() {
        ...
        sidebar.add(buildPanel("Validasi",   validationPanel, 195));
        sidebar.add(Box.createVerticalStrut(10));
        sidebar.add(buildPanel("Solver",     solverPanel,     200));
    ...
    private void runSolver(int heuristic) {
        ...
        currentWorker=new SwingWorker<SolverResult, Void>() {
            @Override protected SolverResult doInBackground() {
                return new Astar(heuristic).solve(boardSnapshot);
            }
